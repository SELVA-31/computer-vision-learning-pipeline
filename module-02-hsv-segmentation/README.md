...
![Red wraps across both ends of the hue range](../assets/diagrams/hue-wrap.svg)
...
Sampling HSV directly from the captured frame, reproducible with
...
Full output, regenerated by the script above: [results/hsv_samples.md](results/hsv_samples.md).
