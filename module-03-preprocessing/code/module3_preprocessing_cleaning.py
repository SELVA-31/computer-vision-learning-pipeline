...
def create_single_screen(panels: dict, labels: dict, screen_w: int = 1600, screen_h: int = 900) -> np.ndarray:
    ...
    panel_w = screen_w // 2
    layout = {
        'top_left': ('blurred', (0, 0)),
        'top_right': ('raw_mask', (0, panel_w)),
        'bottom_left': ('eroded', (panel_h, 0)),
        'bottom_right': ('cleaned', (panel_h, panel_w)),
    }
    ...
    cv2.putText(screen, "Click panel to fullscreen | 'q' quit | 'r' reset", 
